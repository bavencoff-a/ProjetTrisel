...
public class AccesData {
	...
	public static Usager getUsagerlogMdp(String log,String mdp){
		Usager users = null;
		try{
			
			users = (Usager)s.createQuery("from Usager u where u.nomUser = '"+log+"' and u.motDePasse ='"+mdp+"'").uniqueResult();
