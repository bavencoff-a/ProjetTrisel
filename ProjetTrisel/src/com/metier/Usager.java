...
public void setLesHabitations(List<Habitation> lesHabitationss) {
	this.lesHabitations = lesHabitationss;
}
public void addLesHabitations(Habitation habitation) {
	this.lesHabitations.add(habitation);
}
